...
/// * `metric_type` - `&str` for the table metric name for error messages
///
/// # Returns
...
impl AirQualityMetricsModel {
    ...
    pub(crate) async fn insert_row(self, db: &DatabaseConnection) -> Result<u32> {
        insert_row_gen(self.into_active_model(), db, "air quality").await
    }
...
impl DeviceMetricsModel {
    ...
    // * Result with number of rows inserted
    pub(crate) async fn insert_row(self, db: &DatabaseConnection) -> Result<u32> {
        insert_row_gen(self.into_active_model(), db, "device").await
    }
...
impl EnvironmentMetricsModel {
    ...
    // * Result with number of rows inserted
    pub(crate) async fn insert_row(self, db: &DatabaseConnection) -> Result<u32> {
        insert_row_gen(self.into_active_model(), db, "environment").await
    }
...
impl ErrorMetricsModel {
    ...
    // * Result with number of rows inserted
    pub(crate) async fn insert_row(self, db: &DatabaseConnection) -> Result<u32> {
        insert_row_gen(self.into_active_model(), db, "errormetrics").await
    }
...
impl LocalStatsModel {
    ...
    // * Result with number of rows inserted
    pub(crate) async fn insert_row(self, db: &DatabaseConnection) -> Result<u32> {
        insert_row_gen(self.into_active_model(), db, "local stats").await
    }
...
impl NeighborInfoModel {
    ...
    // * Result with number of rows inserted
    pub(crate) async fn insert_row(self, db: &DatabaseConnection) -> Result<u32> {
        insert_row_gen(self.into_active_model(), db, "neighborinfo").await
    }
