...
impl Related<super::airqualitymetrics::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Airqualitymetrics.def()
    }
}

impl Related<super::devicemetrics::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Devicemetrics.def()
    }
}

impl Related<super::environmentmetrics::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Environmentmetrics.def()
    }
}

impl Related<super::localstats::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Localstats.def()
    }
}

impl Related<super::neighborinfo::Entity> for Entity {
    fn to() -> RelationDef {
